      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        >
          ...
          <div className="w-full h-[300px] flex items-center justify-center border border-dashed border-zinc-800 rounded-lg">
            <span className="text-zinc-500 text-sm">Próximamente: Gráfico de líneas detallado</span>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-lg font-medium text-zinc-100 mb-6">Composición del Inventario</h3>
          <div className="w-full h-[300px] flex items-center justify-center border border-dashed border-zinc-800 rounded-lg">
            <span className="text-zinc-500 text-sm">Próximamente: Gráfico de distribución de stock</span>
          </div>
        </motion.div>
      </div>
    </div>
